...
namespace Project4
{
    public class VolunteerEmployee : Employee
    {
        ...
        public VolunteerEmployee(int employeeID, bool likesCats, bool likesDogs, bool getsPaid, Project4.OtherPets otherPets, Project4.OtherPets otherPets1, Project4.OtherPets otherPets2, Project4.OtherPets otherPets3)
        {
